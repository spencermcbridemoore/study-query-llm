#!/usr/bin/env python3
"""Idempotently register orchestration + MCQ analysis method identities.

This script is the register-first onboarding path for methods used by:

- LangGraph provenance (`langgraph_run.default`)
- MCQ probe/runtime + analysis result recording methods
"""
...
from study_query_llm.algorithms.orchestration_methods import (
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Register orchestration and MCQ analysis methods. "
            "Definitions only; no execution path changes."
        )
    )
    parser.add_argument(
        "--dry-run",
    ...
    print("=" * 60)
    print("Registering orchestration + MCQ analysis methods")
    ...
    with db.session_scope() as session:
        ...
        registered = register_orchestration_methods(method_svc)
        print("Orchestration method ids:")
