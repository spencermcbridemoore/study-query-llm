...
Run from repo root:
  python scripts/history/analysis/plot_no_pca_multi_embedding.py --data-dir experimental_results
  python scripts/history/analysis/plot_no_pca_multi_embedding.py --data-dir experimental_results --out-dir experimental_results/plots/no_pca_metrics
