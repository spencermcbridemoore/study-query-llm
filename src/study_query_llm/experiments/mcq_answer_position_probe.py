"""MCQ answer-position probe: LLM-generated tests and answer-key distribution stats."""
...
ProgressCallback = Optional[Callable[[int, int, int, int, int], None]]
"""completed, samples, valid_runs, call_errors_count, parse_failures_count"""
